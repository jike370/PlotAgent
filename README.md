...
产品范围以 [`docs/PRODUCT-DECISIONS.md`](docs/PRODUCT-DECISIONS.md) 的已确认决策基线和 [`docs/PRD.md`](docs/PRD.md) 的可实施需求为准；后端进程与 Agent 执行链见 [`docs/BACKEND-ARCHITECTURE.md`](docs/BACKEND-ARCHITECTURE.md)，ContextEnvelope、模型供应商、数据出境与审计见 [`docs/AGENT-CONTEXT-AND-PROVIDERS.md`](docs/AGENT-CONTEXT-AND-PROVIDERS.md)，InviteGrant、共享额度、最小云控制面和签名更新见 [`docs/CLOUD-CONTROL-PLANE.md`](docs/CLOUD-CONTROL-PLANE.md)，local_only、本地安全、诊断、迁移与恢复备份见 [`docs/LOCAL-SECURITY-MIGRATION-DIAGNOSTICS.md`](docs/LOCAL-SECURITY-MIGRATION-DIAGNOSTICS.md)，PlotSpec、PlotPatch 和 ActionPlan 见 [`docs/DOMAIN-CONTRACTS.md`](docs/DOMAIN-CONTRACTS.md)，运行态工作区、`.plotproj` 与导入流水线见 [`docs/PROJECT-STORAGE.md`](docs/PROJECT-STORAGE.md)，派生数据、单位与三层血缘见 [`docs/DATA-TRANSFORMS.md`](docs/DATA-TRANSFORMS.md)，任务调度、取消和崩溃恢复见 [`docs/TASK-RUNTIME.md`](docs/TASK-RUNTIME.md)，分析注册表、AnalysisSpec/Result 与科学边界见 [`docs/ANALYSIS-ENGINE.md`](docs/ANALYSIS-ENGINE.md)，FitSpec/FitResult、非线性公式与导出契约见 [`docs/FITTING-SYSTEM.md`](docs/FITTING-SYSTEM.md)，坐标解析、物理布局与跨 renderer 一致性见 [`docs/RENDERING-PIPELINE.md`](docs/RENDERING-PIPELINE.md)，原生 OPJU 内容、准入与两阶段验证见 [`docs/ORIGIN-EXPORT.md`](docs/ORIGIN-EXPORT.md)。
