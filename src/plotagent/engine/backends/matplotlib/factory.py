"""Shared construction of the qualified Matplotlib backend inventory."""
...
def default_matplotlib_backend(root: Path) -> MatplotlibBackend:
    """Return the one renderer inventory used by desktop and Agent sandboxes."""
