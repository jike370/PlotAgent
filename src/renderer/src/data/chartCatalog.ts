...
export type CompositionMode = 'layer' | 'panel' | 'mixed'
...
export const chartCatalog: ChartType[] = [
  ...
  chart({ id: 'K23', name: '科学图像面板', englishName: 'Scientific image panel', category: '图像与布局', family: 'image', purpose: '呈现带物理尺度、通道与 ROI 的科研图像', dataShape: ['image', 'volume'], requiredFields: ['图像', '比例尺或像素标定'], batchMode: 'conditional', compositionMode: 'mixed', svg: 'mixed', opju: 'O3' }),
  chart({ id: 'K24', name: '分面图', englishName: 'Faceted plot', category: '图像与布局', family: 'facet', purpose: '按变量拆分为共享视觉语法的小面板', dataShape: ['long + facet'], requiredFields: ['基础图字段', '分面变量'], batchMode: 'direct', compositionMode: 'panel', opju: 'O2' }),
  chart({ id: 'K25', name: '多面板复合图', englishName: 'Multi-panel figure', category: '图像与布局', family: 'multi-panel', purpose: '组合多个图表或图像并统一面板编号', dataShape: ['charts', 'images'], requiredFields: ['至少 2 个面板'], batchMode: 'manual', compositionMode: 'mixed', svg: 'mixed', opju: 'O2', favorite: true }),
  ...
  chart({ id: 'S31', layer: 'validation', name: 'XRD 衍射图', englishName: 'XRD diffraction plot', category: '化学与材料', family: 'xrd', purpose: '呈现衍射强度、峰位与参考信息', dataShape: ['angle + intensity', '2D image'], requiredFields: ['角度或 q', '强度'], batchMode: 'direct', compositionMode: 'layer', domains: ['材料', '化学', '地学'], optionalParameters: ['背景', '归一化', '峰宽', '参考卡', '波长'], recent: true, aliases: ['XRD', 'SAXS', 'WAXS'] }),
  ...
  chart({ id: 'S45', layer: 'validation', name: '专题地图', englishName: 'Thematic map', category: '地球与环境', family: 'map', purpose: '在明确 CRS 与投影下显示空间属性', dataShape: ['geo geometry + attributes'], requiredFields: ['几何', '属性', 'CRS'], batchMode: 'conditional', compositionMode: 'panel', domains: ['地学', '环境', '社会科学'], optionalParameters: ['CRS', '投影', '比例尺', '方向', '分类'], svg: 'mixed', opju: 'O2', aliases: ['地图', 'GIS', 'choropleth'] }),
]
