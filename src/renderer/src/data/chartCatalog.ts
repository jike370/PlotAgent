...
export const chartCatalog: ChartType[] = [
  ...
  chart({ id: 'X02', name: '棒棒糖图', englishName: 'Lollipop plot', category: '比较', family: 'lollipop', purpose: '以基线、细线和端点比较类别值', dataShape: ['category + value'], requiredFields: ['类别', '数值'], batchMode: 'direct', compositionMode: 'layer' }),
  chart({ id: 'X03', name: '哑铃与配对变化图', englishName: 'Dumbbell & paired change', category: '比较', family: 'dumbbell', purpose: '比较同一对象的起点和终点', dataShape: ['category + start + end'], requiredFields: ['类别', '起点', '终点'], batchMode: 'direct', compositionMode: 'layer', aliases: ['前后对比', '坡度图'] }),
