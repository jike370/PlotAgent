...
| X02 | 棒棒糖图 / Lollipop | 比较 | `category + value` | 基线、方向、排序、点/线尺度 | 富集、排名、调查 | ✓ / 层·面 | ✓/✓/原 | P1 |
| X03 | 哑铃图 / Dumbbell | 配对比较 | `category + start + end` | 方向、连接、差值标签、分组 | 临床、社会、benchmark | ✓ / 层·面 | ✓/✓/组 | P1 |
...
| X09 | 浮动柱/区间条 / Floating interval bar | 区间 | `category + start + end` | 起止、方向、排序、区间标签 | 工程、临床、计划 | ✓ / 层·面 | ✓/✓/原 | P1 |
