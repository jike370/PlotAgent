...
十个切片均只消费 `EngineDataView`、`PlotDocument` 和公开 Engine Action，不导入旧
`PlotSpec`、resolver、`ResolvedPlot` 或 Origin plan。K01/K02/K03/K06/K07/K08/K18/K20/X02/X23 已有独立渲染、
